...
let vLocalLaw = new Promise( function(resolve,reject) {
	let infocontent = 'https://raw.githubusercontent.com/NYCDOB/LocalLaw97/gh-pages/data/locallaws.json';
	...
	.then((filterArray) => {
				map.on('load', function () {
					map.addSource('_97Source', {
						'type': 'geojson',
						'data': 'https://raw.githubusercontent.com/NYCDOB/LocalLaw97/gh-pages/data/LL97_BBLs_041921.json', 
						'generateId': true 
					})
					map.addSource('_33Source', {
						'type': 'geojson',
						'data': 'https://raw.githubusercontent.com/NYCDOB/LocalLaw97/gh-pages/data/LL33.json',
						'generateId': true
					});
					map.addLayer({
						'id': '97',
